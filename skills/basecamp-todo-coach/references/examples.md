...
> **Moved 2026-09-16.** Drafting IPM updates now belongs to
> `basecamp-initiative-reporter`, which scans a week of activity instead of
> asking the PIC to reconstruct status movements from memory. This example
> stays here as a worked illustration of the format and of the boundary
> between an Epic Brief and its update timeline — do not offer to draft one
> from this skill.
