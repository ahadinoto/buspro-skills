...
and discovery-deliverable reviews.
...
writing it. See the
[reporter's readme](../basecamp-initiative-reporter/README.md#first-run-the-project-registry)
...
[`basecamp-initiative-reporter`](../basecamp-initiative-reporter/README.md)
instead — those read live Basecamp activity.

**Check the whole backlog:**

> Use the basecamp-todo-coach skill. Review all the todos in this project and
